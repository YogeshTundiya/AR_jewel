...
export interface JewelryProduct {
  ...
  model?: string;       // path to 3D model (GLB)
...
export const PRODUCTS: JewelryProduct[] = [
  ...
  },
  {
    ...
    model: "/models/ring-sapphire.glb",
    category: "ring",
    trackingMode: "hand",
    placement: "ring-finger",
    tag: "Exclusive",
  ...
  // Necklaces (face tracking → neck)
  {
    ...
    model: "/models/necklace-gold.glb",
    category: "necklace",
    trackingMode: "face",
    placement: "neck",
    tag: "New",
  },
  {
    ...
    model: "/models/necklace-pearl.glb",
    category: "necklace",
    trackingMode: "face",
    placement: "neck",
  },
  ...
  // Earrings (face tracking → ears)
  {
    ...
    model: "/models/earrings-diamond.glb",
    category: "earring",
    trackingMode: "face",
    placement: "ears",
    tag: "Limited",
  },
  {
    ...
    model: "/models/earrings-hoop.glb",
    category: "earring",
    trackingMode: "face",
    placement: "ears",
  },
  ...
  // Bracelets (hand tracking → wrist)
  {
    ...
    model: "/models/bracelet-gold.glb",
    category: "bracelet",
    trackingMode: "hand",
    placement: "wrist",
    tag: "AR Ready",
